    ...
    //////////////////////////////////////////////////////////////////////////////
        ...
        paths = {
            ...
            dev_js: [
                ...
                'src/js/controllers/client.controller.js',
                'src/js/controllers/volunteer.controller.js',
                'src/js/controllers/facility.controller.js',
                'src/js/controllers/ui.calendar.controller.js',
                'src/js/controllers/*.js',
                'src/js/directives/*.js',
                'src/js/filters/*.js',
                'src/js/services/client.service.js',
                'src/js/services/volunteer.service.js',
                'src/js/services/facility.service.js',
                '!src/js/vendor.js',
